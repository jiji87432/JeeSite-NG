...
<form:form id="inputForm" modelAttribute="testAudit" action="${ctx}/oa/testAudit/save" method="post"
    ...
    <fieldset>
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    <sys:treeselect id="user" name="user.id" value="${testAudit.user.id}" labelName="user.name"
                                    ...
                                    cssClass="form-control required recipient"
                ...
                <td>
                    <form:input cssClass="form-control" path="post" htmlEscape="false" maxlength="50"/>
                </td>
            </tr>
            <tr>
                <td class="tit">调整原因</td>
                <td colspan="5">
                    <form:textarea path="content" class="required" rows="5" maxlength="200"
            ...
            <tr>
                <td class="tit">月增资</td>
                <td colspan="2"><form:input path="addNum" htmlEscape="false" maxlength="50"
                                            cssClass="form-control"/></td>
                <td class="tit">执行时间</td>
                <td colspan="2"><form:input path="exeDate" htmlEscape="false" maxlength="50"
                                            cssClass="form-control"/></td>
            </tr>
            <tr>
